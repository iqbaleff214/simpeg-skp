...
<div class="content">
  <div class="row">
    ...
    <div class="col-md-4">
      <img src="//3.bp.blogspot.com/-U1tLXudlOkI/WDWMo_HEIEI/AAAAAAAAAQw/mJaLppcgg_4aucTHuEQwoNqAPv0ZDkrBQCK4B/s1600/logo%2Bbanjarmasinnn.png" style="height: 200px; margin-top: 50px; margin-left: 10px" class="img-responsive py-4">
    </div>
    <div class="col-md-4"></div>
  </div>
</div>

<body class="hold-transition login-page" style="margin-top: 0; padding-top: 0">
  <div class="login-box">
    <!-- /.login-logo -->
