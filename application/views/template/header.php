  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-mini">KBT</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Banteng</span>
      </a>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cd/Lambang_Kota_Banjarmasin.gif" style="width: 50px;" class="" alt="User Image">
          </div>
...
<!-- 
          ...
          <?php $skp_rencana = uri_string() === 'admin/skp_rencana'; ?>
          <?php $skp_realisasi = uri_string() === 'admin/skp_realisasi'; ?>
          <li class="treeview <?= ($skp_rencana || $skp_realisasi) ? 'active' : ''; ?>">
            <a href="#">
              <i class="fa fa-cubes"></i> <span> e-SKP</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="<?= ($skp_rencana) ? 'active' : ''; ?>"><a href="<?= base_url('admin/skp_rencana') ?>" class=""><i class="fa fa-circle-o"></i>Rencana SKP</a></li>
              <li class="<?= ($skp_realisasi) ? 'active' : ''; ?>"><a href="<?= base_url('admin/skp_realisasi') ?>" class=""><i class="fa fa-circle-o"></i>Realisasi SKP </a></li>
            </ul>
          </li>
