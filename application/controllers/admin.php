...
class Admin extends CI_controller
{
  ...
  public function index()
  {
    $x = [
      ...
      'pegawai' => $this->db->count_all('pegawai'),
      'skp' => $this->db->count_all('skp'),
    ];
  ...
  public function skp_rencana()
  {
    $data = [
      'judul' => ' Rencana SKP',
      'rencana' => true,
      'data' => $this->db->get('skp')->result_array()
    ];
    tpl('admin/skp_rencana/index', $data);
  }

  public function skp_realisasi()
  {
    $data = [
      'judul' => ' Realisasi SKP',
      'rencana' => false,
  ...
  public function skp_kegiatan($id)
  {
    $data = [
      'judul' => ' Kegiatan SKP',
      'rencana' => true,
      'data' => $this->db->where('skp_id', $id)->get('skp_kegiatan')->result_array()
    ];
    tpl('admin/skp_rencana/kegiatan', $data);
  }

  public function skp_kegiatan_realisasi($id)
  {
    $data = [
      'judul' => ' Kegiatan SKP',
      'rencana' => false,
  ...
  public function pengajuan_skp($id = null)
  {
    ...
    if (isset($_POST['simpan'])) {
      ...
      unset($data['id']);
      $this->db->where('id', $id);
      $res = $this->db->update('skp', $data);
      if ($res) {
        return redirect('admin/skp_realisasi');
      }
    } else {
      $data = [
        'skp_id' => $id,
        ...
        'skp' => $this->db->where('id', $id)->get('skp')->row_array()
      ];
      tpl('admin/skp_rencana/pengajuan', $data);
    }
  }
